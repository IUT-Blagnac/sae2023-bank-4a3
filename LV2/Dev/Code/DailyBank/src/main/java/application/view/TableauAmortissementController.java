	...
	public void displayDialog() {
		...
		case EMPRUNT:
			...
			case ANNEE:
				...
				TableView<LigneTableau> tableA = new TableView<LigneTableau>();
				
				TableColumn<LigneTableau, Integer> periodeColumnA= new TableColumn<LigneTableau, Integer>("Numéro période");
				periodeColumnA.setCellValueFactory(new PropertyValueFactory<LigneTableau, Integer>("periode"));
				
				TableColumn<LigneTableau, String> capdColumnA= new TableColumn<LigneTableau, String>("Capital Restant début");
				capdColumnA.setCellValueFactory(new PropertyValueFactory<LigneTableau, String>("capd"));
				
				TableColumn<LigneTableau, String> interetColumnA= new TableColumn<LigneTableau, String>("Montant des intérêts");
				interetColumnA.setCellValueFactory(new PropertyValueFactory<LigneTableau, String>("interet"));
				
				TableColumn<LigneTableau, String> montantpriColumnA= new TableColumn<LigneTableau, String>("Montant du principal");
				montantpriColumnA.setCellValueFactory(new PropertyValueFactory<LigneTableau, String>("montantpri"));
				
				TableColumn<LigneTableau, String> montantremboursementColumnA= new TableColumn<LigneTableau, String>("Montant à rembourser");
				montantremboursementColumnA.setCellValueFactory(new PropertyValueFactory<LigneTableau, String>("montantrem"));
				
				TableColumn<LigneTableau, String> capfColumnA= new TableColumn<LigneTableau, String>("Capital Restant fin");
