...
image::../img/docTech/DS-Update_Client[DS modifier client]
...
image::../img/docTech/DS-Emprunt-Assurance["DS- Emprunt"]
...
image::../img/docTech/DS-Emprunt-Assurance["DS- Assurance"]
