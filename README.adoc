...
|         |Gantt V1 Prévu|https://github.com/IUT-Blagnac/sae2023-bank-4a3/blob/master/LV1/GanttV1_4A3.pdf                                  |affichage du graphe pas optimal, à reprendre (1 seule page). Reprendre liste des tâches pour être sûr de ne rien oublier.Focalisez vous sur V1. Ajoutez les jalons de livraison.
| 16/05  | CdC V2final|                                     |  
|         | Gantt V1 Réalisé |                               |     
|         | Gantt V2 Prevu|         |     
|         | Doc. Tec. V1 |        |    
